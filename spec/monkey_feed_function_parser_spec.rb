...
describe "DoxyHaml Monkey feed Function Parser" do
  ...
  it "should have a qualified name" do
    expect(@feed.qualified_name).to eq "Monkey::feed"
  end

  it "should have an html qualified name" do
    expect(@feed.html_qualified_name).to match /<a href='classzoo_1_1_monkey.html'>Monkey<\/a>::<a href='classzoo_1_1_monkey.html#\w{34}'>feed<\/a>/
  end
